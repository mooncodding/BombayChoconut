  ...
  <v-app>
    <div class="content-wrapper">
      <div v-if="is('Super Admin') || can('product_categories')">
                    ...
                    <template #item.is_display_on_home="{item}">
                      ...
                      <template v-slot:item.actions="{ item }">
                        <v-icon
                          ...
                          small
                          @click="viewProductCategory(item)"
                        >
                          mdi-eye
                        </v-icon>
                        ...
                        <v-icon
                          ...
                          v-if="
                            is('Super Admin') || can('edit_product_category')
                          "
                        >
                          mdi-pencil
                        </v-icon>
                        ...
                        <v-icon
                          ...
                          v-if="
                            is('Super Admin') || can('delete_product_category')
                          "
                        >
                          mdi-delete
                        </v-icon>
        ...
        <!-- /.content -->
        <addEditProductCategoryModal></addEditProductCategoryModal>

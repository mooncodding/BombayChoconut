        ...
        <section class="breadcrumb-bg" style="background-image:url({{ asset('web-assets/images/banner/shop.jpg') }})">
            <div class="theme-container container ">
                <div class="site-breadcumb white-clr">
                    <h2 class="section-title"> <strong class="clr-txt">Special </strong> <span class="light-font">Offers
                        </span> </h2>
        ...
        <section class="shop-wrap sec-space-bottom">
            ...
            <div class="container rel-div">
                <div class="organic-wrap">
                    ...
                    <div class="tabs-box">
                        <h2 class="section-title ptb-15"> <span class="light-font">Shop By </span> <strong>Categories
                            </strong> </h2>
